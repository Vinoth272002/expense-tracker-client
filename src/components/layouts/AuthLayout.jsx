    ...
    return (
        <div className="flex">
            <div className="w-screen h-screen md:w-[60vw] px-12 pt 8 pb-12">
                <h2 className="text-lg font-medium text-black mt-4">Expense Tracker</h2>
                { children }             
            </div>
            ...
            <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
                ...
                <div className="grid grid-cols-1 z-20">
                    <StatsInfoCard icon={ <LuTrendingUpDown/> } label="Track Your Income & Expense" value="430,000" color="bg-primary"></StatsInfoCard>
                </div>

                <img src={ CARD_2 } alt="CARD_2" className="w-64 lg:w-[90%] absolute bottom-10 rounded-[20px]"/>
            </div>
        </div>
    )
}
